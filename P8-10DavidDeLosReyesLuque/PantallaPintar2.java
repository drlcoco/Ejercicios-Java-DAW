...
public class PantallaPintar2 extends JFrame implements ChangeListener, ActionListener{
	...
	Pintar2 pintura = new Pintar2();
	
	public static void main(String[] args) {
		PantallaPintar2 p = new PantallaPintar2();
		p.go();
	...
	public PantallaPintar2() {
		...
		JMenuItem inicio = new JMenuItem("Inicializar");
		menu1.add(inicio);
		inicio.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				sld_rojo.setValue(0);
				sld_verde.setValue(0);//PONE LOS SLIDERS EN LA POSICIÓN 0 Y EL RECTÁNGULO NEGRO
				sld_azul.setValue(0);
				txf_color.setBackground(Color.BLACK);
			}
		});
		...
		salir.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				dispose();//CIERRA EL PROGRAMA Y LO LIMPIA
			}
		});
		...
		aleatorio.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				pintura.setR((int) (Math.random()*255 + 1)); //ESTABLECE VALORES ALEATORIOS A LAS VARIABLES
				pintura.setG((int) (Math.random()*255 + 1));
				pintura.setB((int) (Math.random()*255 + 1));
				txf_color.repaint();
				txf_color.setBackground(new Color(pintura.getR(), pintura.getG(), pintura.getB()));//PINTA DEL COLOR ALEATORIO
			}
		});
